...
char* tables_init[] = {
    ...
    "CREATE TABLE IF NOT EXISTS UsersData (Id INTEGER PRIMARY KEY AUTOINCREMENT, About TEXT, Status INTEGER, TNumber CHAR, Email TEXT, Era INTEGER, Money INTEGER, LastUpdate CHAR, AvatarId Integer) ;",
