...
void view_modern_era(t_current_window_info *current_layout_info) {
    GtkCssProvider *cssProvider = gtk_css_provider_new(); 
    gtk_css_provider_load_from_path(cssProvider, get_path_to_style("modern_era.css"), NULL); 
    ...
    gtk_builder_add_from_file(current_layout_info->builder, get_path_to_glade("modern_era.glage"), NULL);
    ...
    GtkWidget *quiz_icon_img = gtk_image_new_from_file("./client/resources/static/images/modern_quiz_icon.png");
    ...
    GtkWidget *shop_icon_img = gtk_image_new_from_file("./client/resources/static/images/modern_shop_icon.png");
    ...
    GtkWidget *settings_icon_img = gtk_image_new_from_file("./client/resources/static/images/modern_settings_icon.png");
